...
labels_dict = {
    ...
    6: 'D', 7: 'D', 8: 'E', 9: 'E', 10: 'F', 11: 'F', 
    12: 'G', 13: 'G', 14: 'H', 15: 'H', 16: 'I', 17: 'I', 
    18: 'K', 19: 'K', 20: 'L', 21: 'L', 22: 'M', 23: 'M', 
    24: 'N', 25: 'N', 26: 'O', 27: 'O', 28: 'P', 29: 'P', 
    30: 'Q', 31: 'Q', 32: 'R', 33: 'R', 34: 'S', 35: 'S', 
    36: 'T', 37: 'T', 38: 'U', 39: 'U', 40: 'V', 41: 'V', 
    42: 'W', 43: 'W', 44: 'X', 45: 'X', 46: 'Y', 47: 'Y'
}
...
while True:
    ...
    if results.multi_hand_landmarks:
        for idx, (hand_landmarks, hand_handedness) in enumerate(zip(results.multi_hand_landmarks, results.multi_handedness)):
            ...
            # Kiểm tra nếu camera trước đang bị ngược
